...
public class Relatorio_Usuario extends javax.swing.JInternalFrame {
    ...
    private void preencherTabela(){
        ...
        for(Usuario usuario : users){
            ...
            //table.getCellEditor(table.getModel().getRowCount()-1, 3).;
        }
    ...
    if(s!=-1){
        ...
        if(PerUsuario.excluir((Integer)table.getValueAt(table.getSelectedRow(), 0))){
            JOptionPane.showMessageDialog(rootPane, " Usuário deletado com sucesso!", "Car Fácil - Protype 1", JOptionPane.INFORMATION_MESSAGE);
            preencherTabela();
        }else{
            JOptionPane.showMessageDialog(rootPane, " Erro ao deletar!", "Car Fácil - Protype 1", JOptionPane.ERROR_MESSAGE);            
        }
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    }
    ...
    if(s!=-1){
        ...
        if(PerUsuario.alterar(usr)){
            JOptionPane.showMessageDialog(rootPane, " Usuário alterado com sucesso!", "Car Fácil - Protype 1", JOptionPane.INFORMATION_MESSAGE);
            preencherTabela();            
        }else{
            JOptionPane.showMessageDialog(rootPane, " Erro ao alterar!", "Car Fácil - Protype 1", JOptionPane.ERROR_MESSAGE);             
        }
        preencherTabela();
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    }
