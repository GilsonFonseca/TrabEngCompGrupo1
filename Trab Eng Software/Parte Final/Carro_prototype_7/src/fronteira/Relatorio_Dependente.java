...
public class Relatorio_Dependente extends javax.swing.JInternalFrame {
    ...
    private void preencherTabela(){
        ...
        ArrayList <Dependente> users=PerDependente.consultar();
        for(Dependente usuario : users){
            Object[] linha = {usuario.getID(),usuario.getNome(),usuario.getCPF(),usuario.getResponsavel()};
    ...
    public Relatorio_Dependente(final Main father) {
        initComponents();
        this.father = father;
        setClosable(true);
        //cria-se a estrutura
        this.addInternalFrameListener(new InternalFrameListener() {
            ...
            public void internalFrameClosing(InternalFrameEvent e) {
                father.relatorio_dependente = false; 
                dispose();
            }
    ...
    if(s!=-1){
        ...
        if(PerDependente.excluir((Integer)table.getValueAt(table.getSelectedRow(), 0))){
            JOptionPane.showMessageDialog(rootPane, " Dependente deletado com sucesso!", "CarBill - Protype 1", JOptionPane.INFORMATION_MESSAGE);
            preencherTabela();
        }else{
    ...
    if(s!=-1){
        ...
        if(PerDependente.alterar(usr)){
            JOptionPane.showMessageDialog(rootPane, " Dependente alterado com sucesso!", "CarBill - Protype 1", JOptionPane.INFORMATION_MESSAGE);
            preencherTabela();            
        }else{
